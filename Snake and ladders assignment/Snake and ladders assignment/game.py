...
print("\n Welcome To SNAKES AND LADDERS Funny Game online")

# Object of Board(object generally creation)
...
# Turn function : generally explains the next turn
def next_turn(pr):
...
def check_snake_bite(new_position, player_name):
    #  Checking snake bite here in the below function.
...
def main():
    ...
    while True:
        ...
        //if dice_roll == 6 and bite is True:
            print("sorry better luck next time. You rolled 6 but got bitten by the snake.")
            p = next_turn(p)
        elif dice_roll != 6:
            p = next_turn(p)
        else:
